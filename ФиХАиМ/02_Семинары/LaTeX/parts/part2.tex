...
\section{Задача 1. Классическое время падения электрона на ядро}
...
\section{Задача 2. Квантование движения в поле
...
\section{Задача 3. Спектр атома водорода}
...
\section{Задача 4. Мезоатом водорода}
...
\section{Задача 5. Тонкая структура головной линии серии Бальмера}
