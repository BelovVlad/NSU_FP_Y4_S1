...
% Использование в документе:
%
%   задачи: \task[номер]{название}; теория: \rtheory{название}
%
% Автонумерация:
%
%   Команда \task сама выводит «Задача N» без лишнего номера.

\expandafter\titleformat\expandafter{\csname section\endcsname}[hang]
    {\normalfont\Large\bfseries\raggedright\color{rtext}}
    {
...
% ------------------------------------------------------------
%
% Формат block: заголовок занимает отдельную строку.
%
...
% ------------------------------------------------------------
%
% Отдельная строка, курсив; следующий уровень после подраздела.
