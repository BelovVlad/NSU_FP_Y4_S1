...
\end{equation*}
%
Интегрирование этой прямой приводит к \rtxt{3}{методу трапеций}.

Если $n=2$, используем квадратичную интерполяцию по трём точкам.
В результате получаем \rtxt{3}{формулу Симпсона}.
...
\rtxt{3}{первый порядок точности}.
...
\end{equation*}
%
и метод трапеций имеет \rtxt{3}{второй порядок точности}.
...
\end{equation*}
%
и метод Симпсона имеет \rtxt{3}{четвёртый порядок точности}.
