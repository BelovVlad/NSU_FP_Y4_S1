...
\begin{tabular}{cccc}
\rconcept{\bfseries Основание}
&
\rconcept{\bfseries Система}
&
\rconcept{\bfseries Цифры}
&
\rconcept{\bfseries Пример}
\\[2mm]
...
\rnote{\bfseries Остатки читаются снизу вверх.}
...
\rnote{\bfseries Целые части читаются сверху вниз.}
...
\begin{tabular}{cccc}
\rconcept{\bfseries $10$}
&
\rconcept{\bfseries $2$}
&
\rconcept{\bfseries $8$}
&
\rconcept{\bfseries $16$}
\\[2mm]
