...
\ifSubfilesClassLoaded{\setcounter{chapter}{1}\setcounter{section}{2}}{}
...
Это \rconcept{метод Ньютона}, или метод Ньютона--Рафсона.
...
Поэтому метод Ньютона обладает \rresult{квадратичной сходимостью}.
