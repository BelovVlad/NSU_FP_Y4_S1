...
\rtheory{Статистические распределения}
...
\rtheory{Условие применимости распределения Больцмана}
...
\rtheory{Распределения Ферми и Бозе}
...
называется \rconcept{энергией Ферми}:
%
\begin{equation*}
    \mu(T=0)
    =
...
\newpage
\task[1]{Вырожденный электронный газ}
...
до $p_F$, что приводит к \rconcept{давлению вырождения}.
...
\newpage
\task[2]{Электроны проводимости в меди}
