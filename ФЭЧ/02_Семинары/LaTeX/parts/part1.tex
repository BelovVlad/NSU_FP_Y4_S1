...
\rtheory{Релятивистская кинематика}
...
\end{equation*}
%
является \rconcept{лоренц-инвариантом}, то есть не изменяется
...
\rtheory{Преобразования Лоренца}
...
\rconcept{лабораторной системе отсчёта},
а штрихованные --- к
\rconcept{движущейся системе отсчёта}.
...
Теперь рассмотрим \rconcept{встречные пучки}.
...
\newpage
\task[3]{Открытие антипротона. BEVATRON}
...
\subsection*{Максимальная переданная энергия}
...
\subsection*{Проверка нерелятивистского предела}
