...
\rtheory{Многократное рассеяние}
...
Введём \rconcept{радиационную длину} $X_0$:
...
\task[1]{Многократное рассеяние протона}
...
\rconcept{Критическая энергия} $E_{\text{кр}}$
...
\task[2]{Потери энергии электрона и мюона в алюминии}
...
\rtheory{Черенковское излучение}
...
возникает \rconcept{черенковское излучение}.
...
\task[3]{Порог черенковского излучения}
...
\rtheory{Взаимодействие \texorpdfstring{$\gamma$}{γ}-квантов с веществом}
...
\task[4]{Кинематика комптоновского рассеяния}
