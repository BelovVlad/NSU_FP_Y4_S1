...
\section*{Основные механизмы взаимодействия с веществом}
...
к \rtxt{3}{потере энергии} частицы.

Многократное рассеяние приводит главным образом к
\rtxt{3}{изменению траектории} движения.
...
\section*{Классическая оценка передачи энергии электрону}


% ------------------------------------------------------------
\section{Задача 1. Пролёт тяжёлой заряженной частицы мимо электрона}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\section{Задача 2. Потери энергии в углероде и свинце}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\section{Задача 3. Зависимость потерь энергии от глубины}
% ------------------------------------------------------------
