...
% Смысловые акценты. Правила и примеры: .github/README.md в корне проекта.
% Используются только существующие розовые и голубые оттенки палитры.
\colorlet{rconceptcolor}{red3}     % термин, определение, условие задачи
\colorlet{rresultcolor}{p3}        % результат, ответ, выделенная формула
\colorlet{rassumptioncolor}{p4}    % предположение, условие применимости
\colorlet{rnotecolor}{red4}        % замечание, тонкость, предупреждение
