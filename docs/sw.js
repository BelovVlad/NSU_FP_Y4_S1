...
const CORE = ['index.html', 'app.js?v=5', 'app.css?v=6', 'knowledge.css?v=3', 'manifest.webmanifest?v=3',
  'search-worker.js', 'notebook/viewer.html', 'notebook/viewer.css?build=16', 'notebook/outline.js?build=2',
